...
<div class="container">
	...
	{ 
		...
		{
			?>
			<div style="margin:10px; float:right;"><a href="photos.php?gallery=<?php echo base64_encode($view->gallery); ?>&&lock=unlock&&email=<?php echo $_SESSION['guast']['email']; ?>" style="padding:10px 40px 10px 40px; background-color:#43ace5; color:#fff; font-weight:bold; border:0px; border-radius:3px; font-size:16px;" >Go Back</a></div>
			<?php
		}
		else
		{
			?>
			<div style="margin:10px; float:right;"><a href="photos.php?gallery=<?php echo base64_encode($view->gallery); ?>&&lock=unlock" style="padding:10px 40px 10px 40px; background-color:#43ace5; color:#fff; font-weight:bold; border:0px; border-radius:3px; font-size:16px;" >Go Back</a></div>
			<?php
		}
	}
	else
	{ 
		...
		{
			?>
			<div style="margin:10px; float:right;"><a href="photos.php?gallery=<?php echo base64_encode($view->gallery); ?>&&email=<?php echo $_SESSION['guast']['email']; ?>" style="padding:10px 40px 10px 40px; background-color:#43ace5; color:#fff; font-weight:bold; border:0px; border-radius:3px; font-size:16px;" >Go Back</a></div>
			<?php 
		}
		else
		{
			?>
			<div style="margin:10px; float:right;"><a href="photos.php?gallery=<?php echo base64_encode($view->gallery); ?>" style="padding:10px 40px 10px 40px; background-color:#43ace5; color:#fff; font-weight:bold; border:0px; border-radius:3px; font-size:16px;" >Go Back</a></div>
			<?php
		}
	} 
	?>
	...
	<div class="">
		...
		<div class="col-md-6 features-right" style="padding-top: 15px;">
			...
			if(!empty($list))
			{
				...
				{
					?>
					<div style="padding-left:5px; padding-right:5px; width:25%; float:left">
						<a href="view-photo.php?view=<?php echo base64_encode($photo->id); ?>"><img src="uploads/photos/watermark/<?php echo $list->webfile; ?>" style="width:100%;"/></a>
						<?php 
