			...
			if(!empty($_SESSION['cart']))
			{
				...
				foreach($_SESSION['cart'] as $key=>$value)
				{
					...
					<div class="col-md-12 payment_box_123" id="">
						<div>
							<div class="col-md-2" style="padding:10px;"><img src="https://s3-eu-west-1.amazonaws.com/photorunner.view/<?php echo $view->webfile; ?>" style="width:140px; height:110px;" /></div>
