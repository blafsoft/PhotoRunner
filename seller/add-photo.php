	...
	<div class="col-md-9 features features-right padding_account" style="margin:20px 0;">
		<div class="col-md-12 form-module" style="max-width: 100%;">
			...
			<div style="clear:both;"></div>
				...
				<div style="clear:both;"></div>
				<textarea type="text" placeholder="Write a message for customer" name="massage" style="width:70%; border-radius:0px; padding:8px; border:1px solid #d9d9d9;" id="massage" ></textarea>
			<div style="clear:both;"></div>
			<div style="float:left">
				<div>
