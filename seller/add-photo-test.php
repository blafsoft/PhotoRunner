...
<body style="background-color:#EBEBEB; font-family: Arial;">
...
<div class="container">
	...
	<div class="col-md-9 features features-right padding_account" style="margin:20px 0;">
		<div class="col-md-12 form-module" style="max-width: 100%;">
			...
			<input type="text" placeholder="Photo Title" name="name" id="name" value="<?php if(isset($photo->name) && !empty($photo->name)) { echo $photo->name; } ?>" style="width:70%;" required="required"/>
			...
			<div id="filerowsdiv">
				...
				<input type="file" name="webfile[]" id="filer_input2" multiple="multiple" required="required">
			</div>
			...
			<div id="div">
				...
				<div style="clear:both"></div>
				<div style="width:25%; float:left"><input type="text" placeholder="Price in $" name="webfileprice" value="" style="width:100%;" class="number_only" id="webfileprice" required="required"/></div>
				<div style="width:25%;float:left"><input type="text" placeholder="Price in &#8364;" name="webfilepriceeuro" value="" style="width:100%;" class="number_only" id="webfilepriceeuro" required="required"/></div>
				<div style="clear:both"></div>

			
				<label style="padding-left:8px;">A3 Print File Price in USD and EURO</label>
				<div style="clear:both"></div>
				<div style="width:25%; float:left"><input type="" placeholder="Price in $" name="printfilepricea3" value="" style="width:100%;" id="printfilepricea3" class="number_only" required="required"/></div>
				<div style="width:25%;float:left"><input type="" placeholder="Price in &#8364;" name="printfilepricea3euro" value="" style="width:100%;" id="printfilepricea3euro" class="number_only" required="required"/></div>
				<div style="clear:both"></div>
				...
				<div style="clear:both"></div>
				<div style="width:25%; float:left"><input type="" placeholder="Price in $" name="printfilepricea4" value="" style="width:100%;" id="printfilepricea4" class="number_only" required="required"/></div>
				<div style="width:25%;float:left"><input type="" placeholder="Price in &#8364;" name="printfilepricea4euro" value="" style="width:100%;" id="printfilepricea4euro" class="number_only" required="required"/></div>
				<div style="clear:both"></div>

				<label style="padding-left:8px;">A5 Print File Price in USD and EURO</label>
				<div style="clear:both"></div>
				<div style="width:25%;float:left"><input type="" placeholder="Price in $" name="printfilepricea5" value="" style="width:100%;" id="printfilepricea5" class="number_only" required="required"/></div>
				<div style="width:25%;float:left"><input type="" placeholder="Price in &#8364;" name="printfilepricea5euro" value="" style="width:100%;" id="printfilepricea5euro" class="number_only" required="required"/></div>
				<div style="clear:both"></div>
...
<?php //sinclude(APP_ROOT.'include/foot.php') ?>
</body>
</html>
