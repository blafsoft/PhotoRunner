...
<div class="header">
		...
		<div class="header-nav">
			<nav class="navbar navbar-default">
				...
				<div class="navbar-header">
					...
					<img src="<?php echo APP_URL; ?>images/logo.png" style="max-width:100%">
				</div>
	...
	<li style="text-align:center; color:#000;"><a class="hvr-overline-from-center button2"style="color:#000;" href="#">Blog</a></li>
						<?php
